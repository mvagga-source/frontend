...
function BoardViewN() {
  ...
  const handleUpdate = () => {
    navigate(`/Community/BoardUpdate/${bno}`);
  };
  ...
  const handleReport = () => {
    ...
    params.append("targetIdName", "bno");
    params.append("targetId",  bno);
    params.append("author", board.member?.nickname || "");
      ...
      {board && (<div className={styles.viewContainer}>
        ...
        <div className={styles.btnArea}>
          ...
          {user && user.id !== board.member?.id && (
            <button 
              type="button" 
              className={styles.postReportBtn} 
        ...
        <div className={styles.navSection}>
          <div className={styles.navRow}>
            ...
            {board.prevBno ? (
              <Link to={`/Community/boardView/${board.prevBno}`} className={styles.navLink}>{board.prevTitle}</Link>
            ) : (
          ...
          <div className={styles.navRow}>
            ...
            {board.nextBno ? (
              <Link to={`/Community/boardView/${board.nextBno}`} className={styles.navLink}>{board.nextTitle}</Link>
            ) : (
